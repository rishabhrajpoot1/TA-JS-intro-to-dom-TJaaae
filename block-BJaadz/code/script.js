...
for (let color of allHrsArray){
  color.style.background = "antiquewhite"
}
...
document.querySelector('.seventeen').style.visibility = "hidden"
...
let para2 = document.createElement('p').innerText = "Append inserts as last child"
...
let para3 = document.createElement('p').innerText = "Prepend inserts as first child"
...
for (let i = 0; i < allBoxArray.length; i++){
if(i%2 == 0){
  console.log(i);
allBoxArray[i].style.backgroundColor = "blue"
}
}
